...
/**
 A wrapper class around the Keychain APIs for working with generic password items. Allows for simpler retrieval, creation, and updating of
 password items. Based on sample code publically available from Apple.
 */
public class KeychainPasswordItem : NSObject {
    // MARK: Types
    ...
    public func renameAccount(_ newAccountName: String) throws {
